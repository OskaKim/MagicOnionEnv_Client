...
namespace GameServer.Hubs {
    ...
    [Ignore]
    public class CharaMoveHubClient : StreamingHubClientBase<global::GameServer.Hubs.ICharaMoveHub, global::GameServer.Hubs.ICharaMoveHubReceiver>, global::GameServer.Hubs.ICharaMoveHub
    {
        static readonly Method<byte[], byte[]> method = new Method<byte[], byte[]>(MethodType.DuplexStreaming, "ICharaMoveHub", "Connect", MagicOnionMarshallers.ThroughMarshaller, MagicOnionMarshallers.ThroughMarshaller);

        protected override Method<byte[], byte[]> DuplexStreamingAsyncMethod { get { return method; } }

        readonly global::GameServer.Hubs.ICharaMoveHub __fireAndForgetClient;

        public CharaMoveHubClient(CallInvoker callInvoker, string host, CallOptions option, MessagePackSerializerOptions serializerOptions, IMagicOnionClientLogger logger)
            : base(callInvoker, host, option, serializerOptions, logger)
        {
            this.__fireAndForgetClient = new FireAndForgetClient(this);
        }
        
        public global::GameServer.Hubs.ICharaMoveHub FireAndForget()
        {
        ...
        public global::System.Threading.Tasks.Task<string[]> JoinAsync(string roomName, string userName)
        {
            return WriteMessageWithResponseAsync<DynamicArgumentTuple<string, string>, string[]> (-733403293, new DynamicArgumentTuple<string, string>(roomName, userName));
        }
        ...
        class FireAndForgetClient : global::GameServer.Hubs.ICharaMoveHub
        {
            readonly CharaMoveHubClient __parent;

            public FireAndForgetClient(CharaMoveHubClient parentClient)
            {
            ...
            public global::System.Threading.Tasks.Task<string[]> JoinAsync(string roomName, string userName)
            {
                return __parent.WriteMessageAsyncFireAndForget<DynamicArgumentTuple<string, string>, string[]> (-733403293, new DynamicArgumentTuple<string, string>(roomName, userName));
            }
    ...
    [Ignore]
    public class ChatAppHubClient : StreamingHubClientBase<global::GameServer.Hubs.IChatAppHub, global::GameServer.Hubs.IChatAppHubReceiver>, global::GameServer.Hubs.IChatAppHub
    {
        ...
        readonly global::GameServer.Hubs.IChatAppHub __fireAndForgetClient;
        ...
        class FireAndForgetClient : global::GameServer.Hubs.IChatAppHub
        {
